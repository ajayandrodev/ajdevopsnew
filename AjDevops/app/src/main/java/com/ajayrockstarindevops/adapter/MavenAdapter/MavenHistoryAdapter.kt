 ...
 */
class MavenHistoryAdapter(val userList: ArrayList<MavenHistoryModel>) : RecyclerView.Adapter<MavenHistoryAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: MavenHistoryModel) {
