 ...
 */
class AnsibleInterAdapter(val userList: ArrayList<AnsibleInterviewModel>) : RecyclerView.Adapter<AnsibleInterAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: AnsibleInterviewModel) {
