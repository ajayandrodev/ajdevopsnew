 ...
 */
class LinuxInterAdapter(val userList: ArrayList<LinuxInterviewModel>) : RecyclerView.Adapter<LinuxInterAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: LinuxInterviewModel) {
