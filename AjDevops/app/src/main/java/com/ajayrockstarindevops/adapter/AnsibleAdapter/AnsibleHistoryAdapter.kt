 ...
 */
class AnsibleHistoryAdapter(val userList: ArrayList<AnsibleHistoryModel>) : RecyclerView.Adapter<AnsibleHistoryAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: AnsibleHistoryModel) {
