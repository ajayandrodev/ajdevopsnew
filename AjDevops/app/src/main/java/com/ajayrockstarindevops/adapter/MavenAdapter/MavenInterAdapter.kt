 ...
 */
class MavenInterAdapter(val userList: ArrayList<MavenInterviewModel>) : RecyclerView.Adapter<MavenInterAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: MavenInterviewModel) {
