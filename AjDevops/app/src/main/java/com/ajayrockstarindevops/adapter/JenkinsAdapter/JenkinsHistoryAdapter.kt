 ...
 */
class JenkinsHistoryAdapter(val userList: ArrayList<JenkinsHistoryModel>) : RecyclerView.Adapter<JenkinsHistoryAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: JenkinsHistoryModel) {
