 ...
 */
class JenkinsInterAdapter(val userList: ArrayList<JenkinsInterviewModel>) : RecyclerView.Adapter<JenkinsInterAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: JenkinsInterviewModel) {
