...
import com.ajayrockstarindevops.model.NagiosModel.NagiosCommandsModel


/**
 * Created by Ajay on 7/9/2018.
 */
class NagiosCommandsAdatper(val userList: ArrayList<NagiosCommandsModel>) : RecyclerView.Adapter<NagiosCommandsAdatper.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: NagiosCommandsModel) {
