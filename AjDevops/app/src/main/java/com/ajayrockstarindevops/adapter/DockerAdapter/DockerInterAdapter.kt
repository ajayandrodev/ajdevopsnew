 ...
 */
class DockerInterAdapter (val userList: ArrayList<DockerInterviewModel>) : RecyclerView.Adapter<DockerInterAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(user: DockerInterviewModel) {
