...
class AnsibleCommandsFragment : Fragment() {
  ...
  override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
    ...
    return inflater.inflate(R.layout.fragment_ansible_commands, container, false)
    ...
    users.add(AnsibleCommandsModel("GIT HISTORY"))
    users.add(AnsibleCommandsModel("GIT COMMANDS"))
    users.add(AnsibleCommandsModel("GIT INTERVIEW QUESTIONS"))
    users.add(AnsibleCommandsModel("GIT ADDITIONAL INFORMATION"))
